...
namespace SdeResearchApi.Migrations
{
    ...
    [Migration("20230711010252_PublicationKey")]
    partial class PublicationKey
    {
            ...
            modelBuilder.Entity("SdeResearchApi.Entities.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("4d69b66a-d085-4e74-b51b-660ed35f43ca"),
                            Type = "User"
                        },
                        new
                        {
                            RoleId = new Guid("73f526b2-dd30-4856-a9d3-561d592fcdfe"),
                            Type = "Admin"
                        });
                });
