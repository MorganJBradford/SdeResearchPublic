...
namespace SdeResearchApi.Migrations
{
    ...
    [Migration("20230630153846_CategoryTypeField")]
    partial class CategoryTypeField
    {
            ...
            modelBuilder.Entity("SdeResearchApi.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("592afd63-3e6e-4b4a-b83b-4971eb8df690"),
                            Type = "User"
                        },
                        new
                        {
                            RoleId = new Guid("e1152fed-a5ae-4c23-8d3c-4588e782a58e"),
                            Type = "Admin"
                        });
                });
